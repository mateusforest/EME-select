...
export const portalNavigation: PortalNavigationItem[] = [
  ...
  { id: 'relacionamento', label: 'Atendimento e visitas', title: 'Toda conversa merece continuidade.', description: 'O espaço para acompanhar proprietários, interessados e visitas.', icon: MessageSquare, group: 'Sua operação', status: 'planned' },
  { id: 'locacoes', label: 'Locações', title: 'Cuidar também é acompanhar.', description: 'Contratos, manutenção e compromissos da administração mensal.', icon: KeyRound, group: 'Sua operação', status: 'planned' },
  { id: 'documentos', label: 'Documentos', title: 'Informação organizada. Acesso responsável.', description: 'A futura central de documentos privados dos imóveis.', icon: FileText, group: 'Sua operação', status: 'planned' },
  ...
  { id: 'inteligencia', label: 'Central de IA', title: 'Inteligência com supervisão da EME.', description: 'As capacidades previstas para apoiar cada etapa da operação.', icon: Sparkles, group: 'Gestão e inteligência', status: 'planned' },
  { id: 'qualidade', label: 'Qualidade da equipe', title: 'Um padrão que se constrói em equipe.', description: 'Evidências de atendimento para orientar e desenvolver a equipe.', icon: ShieldCheck, group: 'Gestão e inteligência', status: 'planned', adminOnly: true },
