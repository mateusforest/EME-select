...
test('editorial suggestions use property facts without private policy or automatic approval',async()=>{
 ...
 const result={summary:'Texto organizado',recommendation:'acao_sugerida',strengths:['Três dormitórios'],nextActions:[],highlights:['Integração entre os ambientes'],pending:['Conferir conservação'],draftReply:'Casa em Vacaria com três dormitórios e ambientes integrados. O jardim compõe a área externa e permite diferentes usos no dia a dia.'};
