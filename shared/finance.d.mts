...
export interface FinanceRecurrence extends FinanceMeta { id: string; name: string; category: string; amountCents: number; behavior: 'fixed' | 'variable'; costCenter: string; brokerId: string | null; propertyId: string | null; partnerId: string | null; startMonth: string; endMonth: string | null; dueDay: number; competenceDay?: number; competenceOffset?: number; notes?: string; active: boolean }
